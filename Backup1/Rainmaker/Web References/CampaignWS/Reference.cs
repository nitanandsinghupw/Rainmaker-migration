...
namespace Rainmaker.Web.CampaignWS {
    ...
    public partial class CampaignService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        {
            object[] results = this.Invoke("ScrubDNC", new object[] {
                        campaignConnString});
        ...
        private void OnScrubDNCOperationCompleted(object arg)
        {
            ...
            {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.ScrubDNCCompleted(this, new ScrubDNCCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
