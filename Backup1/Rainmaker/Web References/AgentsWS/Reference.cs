...
namespace Rainmaker.Web.AgentsWS {
    ...
    public partial class AgentService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void InsGet_AgentActivityAsync(long agentID, string campaignDB, string ipAddress, string hostName)
        {
            this.InsGet_AgentActivityAsync(agentID, campaignDB, ipAddress, hostName, null);
        }

        /// <remarks/>
        public void InsGet_AgentActivityAsync(long agentID, string campaignDB, string ipAddress, string hostName, object userState)
        {
        ...
        {
            this.AgentActivity_AgentIDAsync(AgentID);
        }
        ...
        public void AgentActivity_AgentIDAsync(long AgentID, object userState)
        {
            ...
            {
                this.AgentActivity_AgentIDOperationCompleted = new System.Threading.SendOrPostCallback(this.AgentActivity_AgentIDOperationCompleted);
            }
