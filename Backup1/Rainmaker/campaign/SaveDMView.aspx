<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SaveDMView.aspx.cs"
    Inherits="Rainmaker.Web.campaign.SaveDMView" %>
                        ...
                        <table cellpadding="0" cellspacing="1" border="0" width="35%">
                            <tr>
                                <td colspan="2" valign="top" align="left">
                                    &nbsp;<b>Name the Current View:</b>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:TextBox ID="txtViewName" runat="server" CssClass="txtnormal" MaxLength="50"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <table cellpadding="0" cellspacing="1" border="0" width="35%">
