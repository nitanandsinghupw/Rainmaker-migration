...
{
    public partial class ImportDNC : PageBase
    {
        #region Events
        ...
        private void UploadFile()
        {
            ...
            */
            ...
            if (CheckFile(path, chkFirstLine.Checked, ddlDelimiter.SelectedValue))
            {
                ...
                importparams.allowSevenDigitNums = false;
                importparams.allowTenDigitNums = true;
                ...
                importparams.neverCallType = 0;
                Session["importparams"] = importparams;
                Response.Redirect("ImportMappingsDNC.aspx");
            }
        }
