<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportMappingsDNC.aspx.cs"
    Inherits="Rainmaker.Web.campaign.ImportMappingsDNC" %>
                                                                ...
                                                                <table cellpadding="1" cellspacing="1" width="80%" border="0">
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                                                <tr>
                                                                                    <td valign="bottom" align="left">
                                                                                        ...
                                                                                        </a>&nbsp;&nbsp;<img src="../images/arrowright.gif" alt="" />&nbsp;&nbsp;<b>Import to Master Do Not Call</b>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr valign="bottom">
                                                                        <td align="left" valign="bottom">
                                                                            &nbsp;&nbsp;<asp:LinkButton ID="lbtnBack1" runat="server" PostBackUrl="~/campaign/Import.aspx"><img src="" class="myButton" alt="Back" border="0" alt=""/></asp:LinkButton>
