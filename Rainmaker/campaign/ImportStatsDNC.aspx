<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportStatsDNC.aspx.cs" Inherits="Rainmaker.Web.campaign.ImportStatsDNC" %>
                                    ...
                                    <tr valign="bottom">
                                        <td align="right" valign="bottom">
                                            <table cellspacing="5" width="100%" cellpadding="5" border="0" id="Table4">
                                                <tr valign="bottom">
                                                    <td align="right" valign="bottom">
                                                        <asp:LinkButton ID="lbtnBack" runat="server" PostBackUrl="~/campaign/ImportMappingsDNC.aspx"><img src="" class="myButton" alt="Back" border="0" /></asp:LinkButton>&nbsp;&nbsp;<asp:LinkButton
                                                            ID="lbtnUpload" runat="server" PostBackUrl="~/campaign/MasterDNC.aspx"><img src="" class="myButton" alt="OK" border="0" /></asp:LinkButton>&nbsp;
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
